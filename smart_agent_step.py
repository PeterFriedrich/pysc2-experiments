# The base for this code is originally from
# https://chatbotslife.com/building-a-smart-pysc2-agent-cdc269cb095d
# A tutorial by sjkb (https://github.com/skjb) on how to build a sc2
# rl agent with the pysc2 api

# more additions to the code from the second tutorial
# https://itnext.io/add-smart-attacking-to-your-pysc2-agent-17fd5caad578

# This code has been modified, commented,
